  ...
  class EmployesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @employe.save
          format.html { redirect_to admin_employe_path(@employe), notice: 'Employe was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @employe.update(employe_params)
          format.html { redirect_to admin_employe_path(@employe), notice: 'Employe was successfully updated.' }
    ...
    def destroy
      @employe.destroy
      respond_to do |format|
        format.html { redirect_to admin_employes_url, notice: 'Employe was successfully destroyed.' }
    ...
    private
      ...
      def employe_params
        params.require(:employe).permit(:name, :image_url, :comment)
      end
  end
end