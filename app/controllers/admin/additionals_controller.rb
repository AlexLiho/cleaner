  ...
  class AdditionalsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @additional.save
          format.html { redirect_to admin_additional_path(@additional), notice: 'Additional was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @additional.update(additional_params)
          format.html { redirect_to admin_additional_path(@additional), notice: 'Additional was successfully updated.' }
    ...
    def destroy
      @additional.destroy
      respond_to do |format|
        format.html { redirect_to admin_additionals_url, notice: 'Additional was successfully destroyed.' }
    ...
    private
      ...
      def additional_params
        params.require(:additional).permit(:title, :description, :price, :time_for_job, :quantity)
      end
  end
end