module Admin
  class OrdersController < ApplicationController
    ...
    private
      ...
      def order_params
        params.require(:order).permit(:name, :phone, :comment, :total_price, :total_time_for_gob, :wishes_date, :cleaners_date, :general_id, :additional_id, :subtotal, :order_status_id)
      end
  end
end