  ...
  class GeneralsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @general.save
          format.html { redirect_to admin_general_path(@general), notice: 'General was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @general.update(general_params)
          format.html { redirect_to admin_general_path(@general), notice: 'General was successfully updated.' }
    ...
    private
      ...
      def general_params
        params.require(:general).permit(:title, :description, :price, :time_for_job, :quantity)
      end
  end
end