...
class EmployesControllerTest < ActionController::TestCase
  ...
  test "should create employe" do
    assert_difference('Employe.count') do
      post :create, employe: { comment: @employe.comment, image_url: @employe.image_url, name: @employe.name }
    end
  ...
  test "should update employe" do
    patch :update, id: @employe, employe: { comment: @employe.comment, image_url: @employe.image_url, name: @employe.name }
    assert_redirected_to employe_path(assigns(:employe))
  end
