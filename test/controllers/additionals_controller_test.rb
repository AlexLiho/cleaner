...
class AdditionalsControllerTest < ActionController::TestCase
  ...
  test "should create additional" do
    assert_difference('Additional.count') do
      post :create, additional: { price: @additional.price, time_for_job: @additional.time_for_job, title: @additional.title }
    end
  ...
  test "should update additional" do
    patch :update, id: @additional, additional: { price: @additional.price, time_for_job: @additional.time_for_job, title: @additional.title }
    assert_redirected_to additional_path(assigns(:additional))
  end
