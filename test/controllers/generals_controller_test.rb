...
class GeneralsControllerTest < ActionController::TestCase
  ...
  test "should create general" do
    assert_difference('General.count') do
      post :create, general: { price: @general.price, time_for_job: @general.time_for_job, title: @general.title }
    end
  ...
  test "should update general" do
    patch :update, id: @general, general: { price: @general.price, time_for_job: @general.time_for_job, title: @general.title }
    assert_redirected_to general_path(assigns(:general))
  end
